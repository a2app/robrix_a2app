...
pub enum Permission {
    ...
    RobrixComposer,
    /// Resize, move, pop out or minimize its pane, bring it back into its room on its own, badge its tab, and ask for keyboard focus.
    RobrixUi,
...
impl Permission {
    ...
    pub fn blurb(self) -> &'static str {
        match self {
            ...
            Permission::RobrixUi => "Resize, move, pop out or minimize its pane, bring it back into its room on its own, badge its tab, and ask for keyboard focus.",
