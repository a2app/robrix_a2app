...
script_mod! {
    ...
    mod.widgets.ICON_PANEL_LEFT       = crate_resource("self://resources/icons/panel_left.svg")
    mod.widgets.ICON_PANEL_RIGHT      = crate_resource("self://resources/icons/panel_right.svg")
    mod.widgets.ICON_PANEL_TOP        = crate_resource("self://resources/icons/panel_top.svg")
    mod.widgets.ICON_PANEL_BOTTOM     = crate_resource("self://resources/icons/panel_bottom.svg")
